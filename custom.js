    ...
    var config = {
        ...
        data: {
            datasets: [{
                ...
                data: [
                    statusGroup.passParent, statusGroup.failParent,statusGroup.abortParent,statusGroup.inProgressParent,statusGroup.waitingParent
                ],
                backgroundColor: [
                    "#00af00", "#F7464A","grey","#8bc34a","#1e90ff"
                ]
            }],
            labels: ["Pass", "Fail","Abort","In Progress","Waiting"]
        },
        options: options
    };
